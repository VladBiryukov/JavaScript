...
class Slider {
    constructor(clas) {
        // линия со слайдами
        this.sliderLine = document.getElementsByClassName(`${clas}__line_js`)[0];
        // стрелка влево
        this.sliderСontrolLeft = document.getElementsByClassName(`${clas}__control_js`)[0];
        // стрелка вправо
        this.sliderСontrolRight = document.getElementsByClassName(`${clas}__control_js`)[1];
        // slider items
        this.sliderItem = document.querySelectorAll(`.${clas}__item_js`);
        // box  с булями
        this.sliderBoxBullet = document.getElementsByClassName(`${clas}__box-bullet_js`)[0];
        // будущие були
        this.sliderBullet;
        // customn controls
    ...
    clickCustomControls(left, right) {
        ...
        if (this.customControlsLeft && this.customControlsRight) {
            ...
            return this.customControlsLeft, this.customControlsRight;
        }
    }
}
